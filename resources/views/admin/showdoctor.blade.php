                                      ...
                                      <table class="table">
                                          <thead>
                                              <tr>
                                                  ...
                                                  <th style="color: aliceblue; font-size:14px">Availability</th> <!-- New column -->
                                          ...
                                          <tbody>
                                              @foreach ($data as $doctor)
                                                  <tr>
                                                      ...
                                                      <td>{{$doctor->room}}</td>
                                                      <td>
                                                          <!-- Display availability as "Available" or "Unavailable" -->
                                                      ...
                                                      <td>
                                                          <a onclick="return confirm('Are you sure to delete this?')" href="{{url('deletedoctor', $doctor->id)}}">
